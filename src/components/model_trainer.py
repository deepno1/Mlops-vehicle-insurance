...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,data_transformation_artifact):
        ...
        try:
            ...
            train_arr = load_numpy_array_data(file_path=data_transformation_artifact.transformed_train_arr_file_path)
            test_arr = load_numpy_array_data(file_path=data_transformation_artifact.transformed_test_arr_file_path)
            ...
            preprocessing_obj = load_object(file_path=data_transformation_artifact.transformed_obj_file_path)
